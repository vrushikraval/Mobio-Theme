...
Encore
    ...
    .addEntry('app', './themes/mobio-theme/assets/entry.js')
    .disableSingleRuntimeChunk()
    .cleanupOutputBeforeBuild()
    .enableSourceMaps(!Encore.isProduction())
    .enableVersioning(Encore.isProduction())
...
const mobioThemeConfig = Encore.getWebpackConfig();
mobioThemeConfig.name = 'mobioTheme';
...
module.exports = [shopConfig, adminConfig, appShopConfig, mobioThemeConfig, appAdminConfig];
